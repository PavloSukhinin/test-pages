...
<div>
  <div class="author">
    <div class="avatar-wrapper">
      <object class="avatar-object" data={serhiiYanchuk2023Avatar} role="img" aria-label="Serhii Yanchuk"></object>
    </div>
    <div class="profile">
      <h3 class="name">Serhii Yanchuk</h3>
      <ul class="contacts">
        <li><a href="https://www.linkedin.com/in/serhii-yanchuk-b304331a6/" rel="author" class="linkedin"><FontAwesomeIcon icon={faLinkedin} className="icon" /><span>serhii-yanchuk</span></a></li>
        <li><a href="https://www.instagram.com/serhii._.yanchuk/" rel="author" class="instagram"><FontAwesomeIcon icon={faInstagram} className="icon" /><span>serhii._.yanchuk</span></a></li>
      </ul>
      <p class="about">
