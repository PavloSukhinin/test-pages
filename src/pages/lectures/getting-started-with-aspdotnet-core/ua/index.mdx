...
<Language
  currentLanguage="ua"
  languages={{"ua": "lectures/getting-started-with-aspdotnet-core/ua", "ru": "lectures/getting-started-with-aspdotnet-core"}
}/>

<VideoWrapper duration="28 хв 14 сек">
...
<div>
  <div class="author">
    ...
    <div class="profile">
      <h3 class="name">Нікіта Краснов</h3>
      <ul class="contacts">
        <li>
        ...
        <li>
          <a href="https://github.com/k-r-s-n-v" rel="author" class="github">
  ...
  <div class="bubble" style="margin: -0.5em 1em 1em;">
    ...
    Поїхали! <span class="tooltip" data-tooltip="Так, я люблю самокати!">🛴</span>
  </div>
</div>
...
<ThatsAllFolks />
<div class="bubble">
  Ось так коротко про ASP.NET Core. На цьому все, дуже дякую за увагу🎩! Ставте питання та залишайте відгуки на лекцію на сайті академії. Успіхів з домашкою, скоро побачимося, бувай! <span class="tooltip" data-tooltip="Садится на самокат,&#x000A;Уезжает в закат.&#x000A;Но обещал вернуться.">🛴</span>
</div>
