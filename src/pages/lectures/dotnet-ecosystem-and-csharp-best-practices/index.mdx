...
<VideoWrapper duration="1 год 8 хв">
...
<div>
  ...
  <div class="bubble" style="margin: -0.5em 1em 1em;">
    <strong class="dorov">Привіт!</strong>
    ...
    <ol class="compact inverted">
      ...
      <li>вибачаюсь за "беее" і "ееем" у відео, воно само 😅;</li>
...
<p style="margin-left: 0.25em;">Зараз компанія Microsoft вкладає досить багато ресурсів у розвиток .NET та їхньої хмарної платформи — Azure <em>(Ажур, Ежур, Ейжа)</em> та найбільше контрибьютить в open source. 
...
<ul>
  ...
  <li class="details">
    ...
    <div class="details-body details-body-with-image" style="margin-bottom: 0.5em;">
      ...
      <p>У листопаді 2020 року компанія Microsoft випустила платформу <strong>.NET 5</strong>, яка стала серьйозним поліпшенням системи розробки в цілому.
         Головним нововведенням, в порівнянні з <strong>.NET Framework 4.8</strong>, стало забезпечення підтримки <strong>Linux</strong>, <strong>macOS</strong>, <strong>iOS</strong>, <strong>Android</strong>, <strong>tvOS</strong>, <strong>watchOS</strong> і <strong>WebAssembly</strong>. 
         При цьому версія Framework 4.8 залишиться останньою, далі розвиватися буде тільки сімейство .NET <em>x</em>. 
         Це дозволило уніфікувати платформу і запропонувало єдиний відкритий фреймворк і <em>runtime</em> для різних завдань. В результаті можна створювати додатки для різних платформ на загальній кодової базі з однаковим процесом збiрки незалежно від типу програми.
         І розробляти можна за допомогою <strong>Visual Studio</strong>, <strong>Visual Studio for Mac</strong>, <strong>Visual Studio Сode</strong> ― на чому завгодно.
      </p>
      <p>А вже у листопаді 2021 року зарелізився <strong>.NET 6.</strong></p>
    </div>
  </li>
  <li class="details">
...
<Level id="bonus" number="" name="Корисні ресурси" difficulty="" objectives="" labels={{ level: "Бонус", backToTop: "нагору", difficulty: "", objectives: "" }} />
<div class="columns">
