...
import { default as meme } from '../assets/meme_ua.jpg';
import "../styles.css";
...
<Language
  currentLanguage="ua"
  languages={{"ru": "lectures/modern-php-features-and-ecosystem", "ua": "lectures/modern-php-features-and-ecosystem/ua"}
}/>
...
<div>
  <div class="author">
    <div class="avatar-wrapper">
      <object class="avatar-object" data={LenchVolodymyr2021Avatar} role="img" aria-label="My profile picture"></object>
    </div>
    <div class="profile">
      <h3 class="name">Володимир Лєнч</h3>
      <ul class="contacts">
        <li>
          <a href="https://github.com/lenchv" rel="author" class="github">
            <FontAwesomeIcon icon={faGithub} className="icon" />
            <span>lenchv</span>
          </a>
        </li>
        <li>
          <a href="https://www.facebook.com/people/%D0%92%D0%BB%D0%B0%D0%B4%D0%B8%D0%BC%D0%B8%D1%80-%D0%9B%D0%B5%D0%BD%D1%87/100000740939113/" rel="author" class="facebook">
            <FontAwesomeIcon icon={faFacebookSquare} className="icon" />
            <span>Володимир Лєнч</span>
          </a>
        </li>
        <li>
          <a href="https://www.instagram.com/vladimirlench/" rel="author" class="instagram">
...
Multi thread with POSIX and `--pthreads` extension. High-load tasks with message queue systems (RabbitMQ, etc.).
  ...
  <li class="details">
    ...
    <label class="summary" for="accordion-1-6">
...
<li class="details">
  ...
  <label class="summary" for="accordion-22">
    <span class="badge badge-secondary" data-badge="7.1">Nullables</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-23">
    <span class="badge badge-secondary" data-badge="7.1">Void type</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-24">
    <span class="badge badge-secondary" data-badge="7.1">Iterable type</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-25">
    <span class="badge badge-secondary" data-badge="7.4">Spread operator</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-26">
    <span class="badge badge-secondary" data-badge="7.4">Arrow functions</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-27">
    <span class="badge badge-secondary" data-badge="7.4">Typed properties</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-28">
    <span class="badge badge-secondary" data-badge="7.4">Null coalescing assignment operator</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-29">
    <span class="badge" data-badge="8.0">Named arguments</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-30">
    <span class="badge" data-badge="8.0">Attributes</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-31">
    <span class="badge" data-badge="8.0">Constructor property promotion</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-32">
    <span class="badge" data-badge="8.0">Union types</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-33">
    <span class="badge" data-badge="8.0">Match expression</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-34">
    <span class="badge" data-badge="8.0">Nullsafe operator</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-35">
    <span class="badge" data-badge="8.0">Just-In-Time compilation</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-36">
    <span class="badge" data-badge="8.1">Enums</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-37">
    <span class="badge" data-badge="8.1">Readonly properties</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-38">
    <span class="badge" data-badge="8.1">New in initializers</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-39">
    <span class="badge" data-badge="8.1">Pure intersection types</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-40">
...
export const metadata = {
  ...
  keywords: ["hola", "guapa"],
  duration: "55 мин",
  publishedAt: "2021-12-08T22:00:00",
