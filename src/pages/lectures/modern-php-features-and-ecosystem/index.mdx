...
<Level id="whats-new-in-php" number="2" name="What's new in PHP 7" difficulty="Hardcore." objectives="Learn what PHP 7 can offer us." />
...
<li class="details">
  ...
  <label class="summary" for="accordion-25">
    <span class="badge" data-badge="7.4">Spread operator</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-26">
    <span class="badge" data-badge="7.4">Arrow functions</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-27">
    <span class="badge" data-badge="7.4">Typed properties</span>
  </label>
  <div class="details-body">
...
<li class="details">
  ...
  <label class="summary" for="accordion-28">
    <span class="badge" data-badge="7.4">Null coalescing assignment operator</span>
  </label>
  <div class="details-body">
