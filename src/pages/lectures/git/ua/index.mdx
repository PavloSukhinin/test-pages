...
2. Додайте наступні завдання до проекту **"Resume"** проекту та перетворіть їх на issues —
   ...
   Додайте задані **описи** до завдань. (Інструкції, виділені жирним - важливі, не ігноруй їх 😉)
...
3. Перевір свій HTML та CSS на валідність. Можеш скористатися [HTML validator](https://html5.validator.nu/) або [CSS validator](https://stylelint.io/demo) для цього.
