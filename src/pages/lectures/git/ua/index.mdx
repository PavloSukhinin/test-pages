...
<div>
  <div class="author">
    ...
    <div class="profile">
      <h3 class="name">Вікторія Василенко</h3>
      <p class="about">
  ...
  <div class="bubble" style="margin: -0.5em 1em 1em;">
    ...
    <ol class="compact inverted">
      ...
      <li>
        ...
        <em>
          (ви можете ігнорувати їх, якщо відчуваєте себе достатньо просунутими)
        </em>
        ;
      </li>
      <li>
...
1. Переконайтеся, що у вас встановлено <a href="https://git-scm.com/downloads"><strong>Git</strong></a> - він вам знадобиться 😉.
   ...
   <div>
     {" "}
     Ми будемо використовувати <strong>GitHub</strong> сьогодні. Для початку, переглянь{" "}
     <a href="https://guides.github.com/activities/hello-world/">
       <strong>Hello World</strong>
     </a> гайди, щоб отримати огляд термінології та основних понять <sup>
       <strong>
...
3. Додай топіки _"personal website homepage resume gh-pages html css binary-studio-academy bsa21"_
...
1. Створи два проекти — **"Homepage"** та **"Resume"** ― використовуючи **Basic kanban** як темплейт для обох. Використай опис (description) для **Homepage** проекту:
   ...
   <div class="bubble small subtle">
     ...
     ! Таким чином ти пам’ятатимеш, що збираєшся зробити, і твій клієнт знатиме про
     роботу, яку ти виконуєш.
   </div>

2. Додайте наступні завдання до проекту **"Resume"** проекту та перетворіть їх на issues —
   використовуйте GitHub **Labels**, **Assignees**, і **Milestones** _([**Mastering Issues**](https://guides.github.com/features/issues/) explains why and how)_:
   ...
   1. **Скласти інтро**  
      Скласти інтро _(вступ)_, де в 2-4 реченнях описати, чим ти займаєшся, що подобається робити, що хочеться робити краще, що важливо робити, чому ти тут.
...
3. Переміщуй завдання в розділ <strong>"In progress"</strong>, поки працюєш над ними. Залишай коментарі під питаннями, призначай відповідні labels та milestones, закривайте issues та tasks після завершення.
...
2.  Створи нову гілку `feature/body` (на основі develop) і використовуй її для редагування основного контенту:
    ...
    4. Створи `patch/content/primary` гілку (на основі `feature/body`) гілки.

    5. Додай основний контент _(e.g. avatar, name, job, contacts, intro, etc.)_ here. Коміть невеликі зміни, додавай змістовні повідомлення.
    ...
    8. Продовжуй далі та заповни резюме <strong>ВЛАСНОЮ</strong> інформацією -
    ...
    9. Змердж обидві гілки в `feature/body` використовуючи pull requests

    10. Змердж `feature/body` в `develop` використовуючи pull request

3.  Відкрий pull request і <strong>змредж `develop` в `main` гілку</strong>.
